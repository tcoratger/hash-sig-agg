...
pub type RoundConstants<const WIDTH: usize, const PARTIAL_ROUNDS: usize> = (
    [[BabyBear; WIDTH]; HALF_FULL_ROUNDS],
    [BabyBear; PARTIAL_ROUNDS],
    [[BabyBear; WIDTH]; HALF_FULL_ROUNDS],
);

#[rustfmt::skip]
pub const RC16: RoundConstants<16, 13> = (
    BabyBear::new_2d_array([
    ...
    BabyBear::new_array([0x5a8053c0, 0x693be639, 0x3858867d, 0x19334f6b, 0x128f0fd8, 0x4e2b1ccb, 0x61210ce0, 0x3c318939, 0x0b5b2f22, 0x2edb11d5, 0x213effdf, 0x0cac4606, 0x241af16d]),
    BabyBear::new_2d_array([
...
#[rustfmt::skip]
pub const RC24: RoundConstants<24, 21> = (
    BabyBear::new_2d_array([
    ...
    BabyBear::new_array([0x1da78ec2, 0x730b0924, 0x3eb56cf3, 0x5bd93073, 0x37204c97, 0x51642d89, 0x66e943e8, 0x1a3e72de, 0x70beb1e9, 0x30ff3b3f, 0x4240d1c4, 0x12647b8d, 0x65d86965, 0x49ef4d7c, 0x47785697, 0x46b3969f, 0x5c7b7a0e, 0x7078fc60, 0x4f22d482, 0x482a9aee, 0x6beb839d]),
    BabyBear::new_2d_array([
...
pub const DIAG16: [BabyBear; 16] = BabyBear::new_array([
...
pub const DIAG24: [BabyBear; 24] = BabyBear::new_array([
